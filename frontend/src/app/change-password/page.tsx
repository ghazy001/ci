            ...
            <section className="relative z-10 flex min-h-screen items-center justify-center px-5 py-10">
                <div className="w-full max-w-[480px]">
                        ...
                        <div className="p-8 sm:p-10">
                            <div className="mb-8 text-center">
                                ...
                                <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-500">
                                    Replace your temporary password to continue using your
                                    TestFlow workspace securely.
                                </p>
                            </div>
                            ...
                            <div className="mt-7 rounded-2xl border border-slate-200 bg-slate-50/80 px-4 py-3">
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-xs leading-5 text-slate-500">
                                        After the update, you’ll be redirected automatically based
                    ...
                    <p className="mt-6 text-center text-xs text-slate-500">
                        Protected access for authorized Capgemini users.
                    </p>
                </div>
            </section>
        </main>
        ...
        <div>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    required
                    className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-11 pr-12 text-sm text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-blue-600 focus:bg-white focus:ring-4 focus:ring-blue-600/10"
                />
