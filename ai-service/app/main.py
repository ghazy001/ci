...
from app.api.v1.routes.test_case_generation_jobs import router as test_case_generation_jobs_router
...
from app.api.v1.routes.automation_script_generation import router as automation_script_generation_router
from app.api.v1.routes.automation_script_generation_jobs import router as automation_script_generation_jobs_router
